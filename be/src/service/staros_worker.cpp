...
DECLARE_int32(fslib_s3client_read_max_retries);
DECLARE_int32(fslib_s3client_read_retry_scale_factor);
...
void init_staros_worker() {
    ...
    FLAGS_fslib_s3client_read_max_retries = config::starlet_fslib_s3client_read_max_retries;
    FLAGS_fslib_s3client_read_retry_scale_factor = config::starlet_fslib_s3client_read_retry_scale_factor;
